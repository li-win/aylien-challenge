...
for row in range(0,nrows):
    ...
    if var1 and var2:
        ...
        var3 = 0
        label_list_all.append(var3)    
df2['Label New'] = label_list_all


#label news articles with -1 (incident) and 0 (no incident)
label_new = {-1: 'Incident', 0: 'Not Incident'}
df2['Label'] = df2['Label New']
df2 = df2.replace({'Label':label_new})
...
df2.to_csv('test_labeling.csv', index=False, header=True)
